...
package com.vsm.mymapstest.data.remote;
...
import com.vsm.mymapstest.data.DataSource;
import com.vsm.mymapstest.model.PostList;
...
public class RemoteDataSource implements DataSource {
    ...
    @Override
    public void getPostImage(@NonNull String url, @NonNull DataSource.GetImageCallback getImageCallback) {
